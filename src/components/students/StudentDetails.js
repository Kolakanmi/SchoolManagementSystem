      ...
      <div className='d-flex flex-wrap px-2'>
        ...
        <div className='flex-fill' style={{display: 'flex', overflowX: 'auto'}}>
          <div className='my-sm-2' style={{border: '2px solid green', padding: '0px', fontSize: '0.8rem', wordWrap: 'break-word'}}>
            ...
            <div className='d-flex' style={{padding: '0px'}} ><p className='col-4 p-0 px-sm-2'>Father's Name:</p> <p className='col-8 p-0 px-sm-2'><strong>{student.parents[0].firstName + ' ' + student.lastName} </strong></p></div>
            <div className='d-flex' style={{padding: '0px'}} ><p className='col-4 p-0 px-sm-2'>Mother's Name:</p> <p className='col-8 p-0 px-sm-2'><strong>{student.parents[1].firstName + ' ' + student.lastName} </strong></p></div>
            ...
            <div className='d-flex' style={{padding: '0px'}} ><p className='col-4 p-0 px-sm-2'>Father's Phone No:</p> <p className='col-8 p-0 px-sm-2'><strong>{student.parents[0].mobileNumber}</strong></p></div>          
            <div className='d-flex' style={{padding: '0px'}} ><p className='col-4 p-0 px-sm-2'>Mother's Phone No:</p> <p className='col-8 p-0 px-sm-2'><strong>{student.parents[1].mobileNumber}</strong></p></div>          
          </div>
        </div> 
